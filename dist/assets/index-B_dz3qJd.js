 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cC(t,e,n=!1){if(pt(t.app))return Promise.reject(xn(t));const r="signIn",i=await S_(t,r,e),s=await Dn._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}function dC(t,e,n,r){return at(t).onIdTokenChanged(e,n,r)}function hC(t,e,n){return at(t).beforeAuthStateChanged(e,n)}const ll="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DC="pendingRedirect",Io=new Map;class LC extends A_{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Io.get(this.auth._key());if(!e){try{const r=await bC(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Io.set(this.auth._key(),e)}return this.bypassAuthState||Io.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function bC(t,e){const n=UC(e),r=FC(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function MC(t,e){Io.set(t._key(),e)}function FC(t){return zt(t._redirectPersistence)}function UC(t){return ko(DC,t.config.apiKey,t.name)}async function zC(t,e,n=!1){if(pt(t.app))return Promise.reject(xn(t));const r=Wl(t),i=xC(r,e),o=await new LC(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wk{constructor(e,n){this.appCheckProvider=n,this.appName=e.name,pt(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=n==null?void 0:n.getImmediate({optional:!0}),this.appCheck||n==null||n.get().then(r=>this.appCheck=r)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((n,r)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,r):n(null)},0)})}addTokenChangeListener(e){var n;(n=this.appCheckProvider)==null||n.get().then(r=>r.addTokenListener(e))}notifyForInvalidToken(){Me(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var _t;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(_t||(_t={}));function Td(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Nd(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function xd(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pl{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=_t.ACK_USER_WRITE,this.source=Td()}operationForChild(e){if(W(this.path)){if(this.affectedTree.value!=null)return C(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new q(e));return new pl(G(),n,this.revert)}}else return C(z(this.path)===e,"operationForChild called for unrelated child."),new pl(Z(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ys{constructor(e,n){this.source=e,this.path=n,this.type=_t.LISTEN_COMPLETE}operationForChild(e){return W(this.path)?new ys(this.source,G()):new ys(this.source,Z(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cr{constructor(e,n,r){this.source=e,this.path=n,this.snap=r,this.type=_t.OVERWRITE}operationForChild(e){return W(this.path)?new cr(this.source,G(),this.snap.getImmediateChild(e)):new cr(this.source,Z(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ti{constructor(e,n,r){this.source=e,this.path=n,this.children=r,this.type=_t.MERGE}operationForChild(e){if(W(this.path)){const n=this.children.subtree(new q(e));return n.isEmpty()?null:n.value?new cr(this.source,G(),n.value):new ti(this.source,G(),n)}else return C(z(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ti(this.source,Z(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wt{constructor(e){this.writeTree_=e}static empty(){return new wt(new J(null))}}function Hi(t,e,n){if(W(e))return new wt(new J(n));{const r=t.writeTree_.findRootMostValueAndPath(e);if(r!=null){const i=r.path;let s=r.value;const o=Le(i,e);return s=s.updateChild(o,n),new wt(t.writeTree_.set(i,s))}else{const i=new J(n),s=t.writeTree_.setTree(e,i);return new wt(s)}}}function Xu(t,e,n){let r=t;return Ne(n,(i,s)=>{r=Hi(r,ue(e,i),s)}),r}function sp(t,e){if(W(e))return wt.empty();{const n=t.writeTree_.setTree(e,new J(null));return new wt(n)}}function Ju(t,e){return mr(t,e)!=null}function mr(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Le(n.path,e)):null}function op(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(ce,(r,i)=>{e.push(new j(r,i))}):t.writeTree_.children.inorderTraversal((r,i)=>{i.value!=null&&e.push(new j(r,i.value))}),e}function Rn(t,e){if(W(e))return t;{const n=mr(t,e);return n!=null?new wt(new J(n)):new wt(t.writeTree_.subtree(e))}}function Zu(t){return t.writeTree_.isEmpty()}function ni(t,e){return hy(G(),t.writeTree_,e)}function hy(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let r=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(C(s.value!==null,"Priority writes must always be leaf nodes"),r=s.value):n=hy(ue(t,i),s,n)}),!n.getChild(t).isEmpty()&&r!==null&&(n=n.updateChild(ue(t,".priority"),r)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qd{constructor(e,n,r,i){this._repo=e,this._path=n,this._queryParams=r,this._orderByCalled=i}get key(){return W(this._path)?null:wd(this._path)}get ref(){return new Jt(this._repo,this._path)}get _queryIdentifier(){const e=rp(this._queryParams),n=gd(e);return n==="{}"?"default":n}get _queryObject(){return rp(this._queryParams)}isEqual(e){if(e=at(e),!(e instanceof Qd))return!1;const n=this._repo===e._repo,r=Ed(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&r&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+pI(this._path)}}class Jt extends Qd{constructor(e,n){super(e,n,new Id,!1)}get parent(){const e=ny(this._path);return e===null?null:new Jt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ws{constructor(e,n,r){this._node=e,this.ref=n,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new q(e),r=sc(this.ref,e);return new ws(this._node.getChild(n),r,ce)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,i)=>e(new ws(i,sc(this.ref,r),ce)))}hasChild(e){const n=new q(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function er(t,e){return t=at(t),t._checkNotDeleted("ref"),e!==void 0?sc(t._root,e):t._root}function sc(t,e){return t=at(t),z(t._path)===null?rN("child","path",e):My("child","path",e),new Jt(t._repo,ue(t._path,e))}function yp(t,e){t=at(t),iN("set",t._path),eN("set",e,t._path);const n=new Ts;return mN(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Vy(t,e){nN("update",e,t._path);const n=new Ts;return gN(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function Hy(t){t=at(t);const e=new Kd(()=>{}),n=new Us(e);return pN(t._repo,t,n).then(r=>new ws(r,new Jt(t._repo,t._path),t._queryParams.getIndex()))}class Us{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const r=n._queryParams.getIndex();return new IN("value",this,new ws(e.snapshotNode,new Jt(n._repo,n._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new TN(this,e,n):null}matches(e){return e instanceof Us?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function NN(t,e,n,r,i){const s=new Kd(n,void 0),o=new Us(s);return yN(t._repo,t,o),()=>zy(t._repo,t,o)}function xN(t,e,n,r){return NN(t,"value",e)}function RN(t,e,n){let r=null;const i=n?new Kd(n):null;r=new Us(i),zy(t._repo,t,r)}TT(Jt);AT(Jt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jN={".sv":"timestamp"};function WN(){return jN}$t.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};$t.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};zN();const Gy={apiKey:"AIzaSyByzCEAfMObQqYNXMOlVXoQd00GMo3QX1M",authDomain:"kelime-oyunu-9a632.firebaseapp.com",databaseURL:"https://kelime-oyunu-9a632-default-rtdb.firebaseio.com",projectId:"kelime-oyunu-9a632",appId:"1:634682520854:web:04707f6bed348d5e61cc37"},Ky=Object.values(Gy).every(Boolean);let $a=null,Ba=null;function zs(){if(!Ky)throw new Error("Firebase yapılandırması eksik.");if(!$a||!Ba){const t=Xg(Gy);$a=FN(t),Ba=Ck(t)}return{db:$a,auth:Ba}}async function Qy(){const{auth:t}=zs();return t.currentUser||await lC(t),t.currentUser.uid}function vp(){return Math.random().toString(36).slice(2,8).toUpperCase()}function $N(){return Ky}async function BN(t,e,n){const r=await Qy(),{db:i}=zs();let s=vp();for(let o=0;o<3;o+=1){const l=er(i,`rooms/${s}`);if(!(await Hy(l)).exists())break;s=vp()}return await yp(er(i,`rooms/${s}`),{createdAt:WN(),wordLength:t,targetWord:e,hostId:r}),await yp(er(i,`rooms/${s}/players/${r}`),{name:n,attempts:0,solved:!1,elapsedSeconds:0,updatedAt:Date.now()}),{code:s,uid:r,hostId:r}}async function VN(t,e){var l,a,u,d,c,h;const n=await Qy(),{db:r}=zs(),i=er(r,`rooms/${t}`),s=await Hy(i);if(!s.exists())return null;const o=s.val();return await Vy(er(r,`rooms/${t}/players/${n}`),{name:e,attempts:((a=(l=o.players)==null?void 0:l[n])==null?void 0:a.attempts)??0,solved:((d=(u=o.players)==null?void 0:u[n])==null?void 0:d.solved)??!1,elapsedSeconds:((h=(c=o.players)==null?void 0:c[n])==null?void 0:h.elapsedSeconds)??0,updatedAt:Date.now()}),{code:t,uid:n,hostId:o.hostId??n,wordLength:o.wordLength,targetWord:o.targetWord}}function HN(t,e){const{db:n}=zs(),r=er(n,`rooms/${t}/players`),i=xN(r,s=>{const o=s.val()??{},l=Object.entries(o).map(([a,u])=>({id:a,...u}));l.sort((a,u)=>{const d=Number(a.attempts??0),c=Number(u.attempts??0),h=Number(a.elapsedSeconds??0),g=Number(u.elapsedSeconds??0);return a.solved!==u.solved?a.solved?-1:1:d!==c?d-c:h-g}),e(l)});return()=>RN(r,"value",i)}async function GN(t,e,n){const{db:r}=zs();await Vy(er(r,`rooms/${t}/players/${e}`),{...n,updatedAt:Date.now()})}const lc=[5,6,7,8],kt=6,wp=$E.reduce((t,e)=>{const n=e.toLocaleUpperCase("tr-TR"),r=[...n].length;return lc.includes(r)&&(t[r]=t[r]??[],t[r].includes(n)||t[r].push(n)),t},{}),KN=[["E","R","T","Y","U","I","O","P","Ğ","Ü"],["A","S","D","F","G","H","J","K","L","Ş","İ"],["ENTER","Z","C","V","B","N","M","Ö","Ç","SİL"]],Ep="wordle-tr6-stats",Sp="wordle-tr6-theme",Cp="wordle-tr6-keyboard-scale",kp=1,Ip=1.9,Tp=.08,QN=1.3,uo={played:0,wins:0,currentStreak:0,bestStreak:0,distribution:Array(kt).fill(0)};function YN(t){if(!t.length)return"KELIME";const e=Math.floor(Date.now()/864e5);return t[e%t.length]}function xo(t){return t.trim().toLocaleUpperCase("tr-TR")}function qN(t){const e=new TextEncoder().encode(t);let n="";return e.forEach(r=>{n+=String.fromCharCode(r)}),btoa(n)}function XN(t){try{const e=atob(t),n=Uint8Array.from(e,r=>r.charCodeAt(0));return xo(new TextDecoder().decode(n))}catch{return null}}function Va(t,e){const n=Array(e.length).fill("absent"),r=e.split(""),i=t.split("");return i.forEach((s,o)=>{r[o]===s&&(n[o]="correct",r[o]="_",i[o]="*")}),i.forEach((s,o)=>{if(s==="*")return;const l=r.indexOf(s);l!==-1&&(n[o]="present",r[l]="_")}),n}function JN(){const[t,e]=b.useState(()=>{const y=localStorage.getItem(Sp);return y==="dark"||y==="light"?y:window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}),[n,r]=b.useState(()=>{var P;const y=localStorage.getItem(Ep);if(!y)return uo;try{const B=JSON.parse(y);return{...uo,...B,distribution:((P=B.distribution)==null?void 0:P.length)===kt?B.distribution:uo.distribution}}catch{return uo}}),[i,s]=b.useState(()=>{const y=localStorage.getItem(Cp),P=y?Number(y):NaN;return!Number.isNaN(P)&&P>=kp&&P<=Ip?P:QN}),[o,l]=b.useState(!1),[a,u]=b.useState(!1),[d,c]=b.useState(!1),[h,g]=b.useState([]),[_,v]=b.useState(!1),[O,p]=b.useState(""),[f,m]=b.useState(""),[w,T]=b.useState(!1),[x,R]=b.useState(""),[k,te]=b.useState(null),[F,je]=b.useState([]),Ot=$N(),xe=b.useMemo(()=>{const P=new URLSearchParams(window.location.search).get("challenge");if(!P)return null;const B=XN(P);return!B||!lc.includes(B.length)?null:B},[]),[V,js]=b.useState((xe==null?void 0:xe.length)??6),[ut,Zt]=b.useState(!!xe),I=b.useMemo(()=>wp[V]??wp[6]??[],[V]),A=(k==null?void 0:k.targetWord)??xe??YN(I),M=b.useMemo(()=>new Set([...I??[],A]),[I,A]),[U,X]=b.useState([]),[Ke,Se]=b.useState(""),[pi,K]=b.useState(`${V} harfli kelimeyi bul.`),[Wn,Yy]=b.useState(""),[Ws,$n]=b.useState(0),[Yd,qd]=b.useState(null),en=b.useRef(!1),mi=b.useRef(null),tn=U.some(y=>y===A),ea=U.length>=kt&&!tn,St=tn||ea;b.useEffect(()=>{K(`${V} harfli kelimeyi bul.`),X([]),Se(""),$n(0),c(!1),v(!1),g([]),en.current=!1},[V,A]),b.useEffect(()=>{document.documentElement.setAttribute("data-theme",t),localStorage.setItem(Sp,t)},[t]),b.useEffect(()=>{localStorage.setItem(Ep,JSON.stringify(n))},[n]),b.useEffect(()=>{localStorage.setItem(Cp,i.toFixed(2))},[i]);const qy=b.useMemo(()=>{const y=[...U];for(St||y.push(Ke);y.length<kt;)y.push("");return y},[U,Ke,St]),Xy=b.useMemo(()=>{const y=new Map;return U.forEach(P=>{const B=Va(P,A);P.split("").forEach((_e,Dt)=>{const gr=B[Dt],nn=y.get(_e)??"unknown";nn!=="correct"&&(nn==="present"&&gr==="absent"||y.set(_e,gr))})}),y},[U,A]);b.useEffect(()=>{function y(P){const B=xo(P.key);if(B==="ENTER"){Zd();return}if(B==="BACKSPACE"){Jd();return}/^[A-ZÇĞİÖŞÜI]$/u.test(B)&&Xd(B)}return window.addEventListener("keydown",y),()=>window.removeEventListener("keydown",y)}),b.useEffect(()=>{if(!(!St||en.current)){if(en.current=!0,r(y=>{const P={...y,played:y.played+1,distribution:[...y.distribution]};if(tn){const B=U.length-1;B>=0&&B<kt&&(P.distribution[B]+=1),P.wins+=1,P.currentStreak+=1,P.bestStreak=Math.max(P.bestStreak,P.currentStreak)}else P.currentStreak=0;return P}),tn){const y=["#22c55e","#06b6d4","#facc15","#a855f7","#f43f5e","#3b82f6"],P=Array.from({length:72}).map((B,_e)=>({id:_e,left:Math.random()*100,color:y[_e%y.length],size:6+Math.random()*8,delay:Math.random()*.4,duration:1.8+Math.random()*1.4,rotate:Math.random()*360}));g(P),window.setTimeout(()=>g([]),3200);return}ea&&c(!0)}},[St,tn,ea,U.length]),b.useEffect(()=>{if(!ut||St)return;const y=window.setInterval(()=>{$n(P=>P+1)},1e3);return()=>window.clearInterval(y)},[ut,St]),b.useEffect(()=>()=>{mi.current&&window.clearTimeout(mi.current)},[]),b.useEffect(()=>{if(k)return HN(k.code,je)},[k]),b.useEffect(()=>{!k||!ut||GN(k.code,k.uid,{attempts:U.length,solved:tn,elapsedSeconds:Ws}).catch(()=>{})},[k,ut,U.length,tn,Ws]);function Xd(y){St||Ke.length>=V||Se(P=>P+y)}function Jd(){St||Se(y=>y.slice(0,-1))}function Zd(){if(St)return;if(Ke.length!==V){K(`Kelime ${V} harfli olmalı.`);return}if(!new RegExp(`^[A-ZÇĞİIÖŞÜ]{${V}}$`,"u").test(Ke)){K("Sadece harf kullanabilirsin.");return}const P=[...U,Ke];if(X(P),Se(""),Ke===A){K("Tebrikler! Kelimeyi buldun.");return}if(P.length>=kt){K(`Bilemedin. Kelime: ${A}`);return}if(!M.has(Ke)){K("Kelime kabul edildi (geniş mod). Devam et.");return}K("Devam et, çok yakınsın.")}function Jy(y){if(y==="ENTER"){Zd();return}if(y==="SİL"){Jd();return}Xd(y)}function eh(y){qd(y),mi.current&&window.clearTimeout(mi.current),mi.current=window.setTimeout(()=>{qd(null)},1e3)}function Zy(){const y=tn?U.findIndex(Bn=>Bn===A)+1:null,P=y??"X",B=xe?`Kelime Oyunu Meydan ${V}H ${P}/${kt}`:`Kelime Oyunu Günlük ${V}H ${P}/${kt}`,_e=U.map(Bn=>Va(Bn,A).map($s=>$s==="correct"?"🟩":$s==="present"?"🟨":"⬛").join("")).join(`
`),Dt=U.map((Bn,$s)=>`${$s+1}. ${Bn}`).join(`
`),gr=y?`Deneme: ${y}/${kt} | Süre: ${ta}`:`Deneme: ${U.length}/${kt} | Süre: ${ta}`,nn=`${B}
${gr}
